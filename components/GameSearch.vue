...
import { BoardGameSearchResult, DisplayableItemType, BoardGameGeekThingItemType, BoardGameGeekItemsType } from '~/helpers/types'
...
export default class GameSearch extends Vue {
  ...
  @Prop({ required: true }) readonly addToCollection!:(item:DisplayableItemType) => void
  ...
  private _getDisplayItemFromSearchResult (entry: BoardGameGeekThingItemType):DisplayableItemType|null {
